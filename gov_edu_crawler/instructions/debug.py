...
URL_TES = "https://www.kemendikdasmen.go.id/siaran-pers/15231-tinjau-sekolah-di-manado-wamen-atip-pastikan-revitalisasi-ha"
SELEKTOR_TES = "div.col-12.col-md-8" # Bisa coba beberapa sekaligus
...
def debug_scraper(url, selector):
    ...
    try:
        ...
        with open(filename, "w", encoding="utf-8") as f:
            f.write(f"# 🛠️ Hasil Debug Selektor\n\n")
            f.write(f"- **URL:** {url}\n")
            ...
            if target:
                ...
                if full_text:
                    ...
                    print(f"✅ Selesai! Silakan cek file: {filename}")
                else:
                    f.write("## ⚠️ STATUS: ELEMENT DITEMUKAN TAPI KOSONG\n")
                    print("⚠️ Konten teks tidak ditemukan di dalam selektor tersebut.")
            else:
                f.write("## ❌ STATUS: GAGAL\n\nSelektor tidak ditemukan di halaman ini.")
                print("❌ Selektor salah atau elemen tidak ada.")
